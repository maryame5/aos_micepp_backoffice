  ...
  template: `
    <div class="news-container">
      ...
      <mat-card class="documents-card">
        ...
        <mat-card-content>
          <div class="table-container" *ngIf="documents.length > 0; else noData">
            <table mat-table [dataSource]="documents" matSort class="documents-table">
        ...
        <form [formGroup]="documentForm" (ngSubmit)="onSubmit()" class="dialog-body">
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <textarea matInput formControlName="description" rows="4"
                      placeholder="Entrez la description de l'actualité" required></textarea>
